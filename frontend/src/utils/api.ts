...
export async function queryRAG(
  ...
  const mockSources: Source[] = [
    {
      id: '1',
      title: language === 'EN' ? 'Ethiopian Trade Policy Report 2024' : 'የኢትዮጵያ ንግድ ፖሊሲ ሪፖርት 2024',
      snippet: language === 'EN'
    ...
    {
      id: '2',
      title: language === 'EN' ? 'Economic Development Analysis' : 'የኢኮኖሚ ልማት ትንተና',
      snippet: language === 'EN'
    ...
    {
      id: '3',
      title: language === 'EN' ? 'Infrastructure Investment Review' : 'የመሠረተ ልማት ኢንቨስትመንት ግምገማ',
      snippet: language === 'EN'
